...
class LandscapeSplashViewBody extends StatefulWidget {
  const LandscapeSplashViewBody({super.key, required this.nextScreen});
  final String nextScreen;

  @override
  State<LandscapeSplashViewBody> createState() => _LandscapeSplashViewBodyState();
}

class _LandscapeSplashViewBodyState extends State<LandscapeSplashViewBody>
      ...
      children: [
        ...
        Positioned(
          ...
          child: SvgPicture.asset(
            ...
            width: size.width,
            color: const Color(0xff015F4D).withOpacity(0.5),
          ),
        ),
        LogoAndNameWidget(
